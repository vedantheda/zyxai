-- ZyxAI Database Schema - AI Voice Business Automation Platform
-- Complete schema for multi-niche AI agent system
...
-- ============================================================================
-- BUSINESS NICHES & AGENT TEMPLATES
-- ============================================================================
...
-- ============================================================================
-- ORGANIZATION-SPECIFIC AGENTS & CAMPAIGNS
-- ============================================================================
...
CREATE TABLE IF NOT EXISTS public.call_events (
  ...
  event_type TEXT NOT NULL, -- 'started', 'human_handoff', 'objection', 'appointment_set', etc.
...
CREATE TABLE IF NOT EXISTS public.integrations (
  id UUID DEFAULT gen_random_uuid() PRIMARY KEY,
  organization_id UUID REFERENCES public.organizations(id) ON DELETE CASCADE NOT NULL,
  integration_type TEXT NOT NULL, -- 'salesforce', 'hubspot', 'pipedrive', 'mls', etc.
  name TEXT NOT NULL,
...
RETURNS TRIGGER AS $$
BEGIN
  -- For now, users will be added to organizations manually
  -- This can be extended to handle organization creation on signup
  RETURN NEW;
END;
