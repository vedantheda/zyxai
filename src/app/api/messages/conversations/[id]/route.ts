...
export async function GET(
  ...
  try {
    ...
    const conversation = await messageService.getConversation(params.id)
...
export async function PUT(
  ...
  try {
    ...
    const messageService = new MessageService(user.id)
    const conversation = await messageService.updateConversation(params.id, body)
...
export async function POST(
  ...
  try {
    ...
    const messageService = new MessageService(user.id)
    const markedCount = await messageService.markAsRead(params.id)
